...
<div class="row"><!-- row no: 1 begin -->
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        ...
        <ol class="breadcrumb dashboard"><!-- breadcrumb begin -->
...
<div class="row"><!-- row no: 2 begin -->
    ...
    <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 begin -->
        <div class="panel panel-primary panel-blue"><!-- panel panel-primary begin -->
...
<div class="row"><!-- row no: 3 begin -->
    <div class="col-lg-8"><!-- col-lg-8 begin -->
        <div class="panel panel-primary panel-orders"><!-- panel panel-primary begin -->
            <div class="panel-heading panel-orders"><!-- panel-heading begin -->
            ...
            <div class="panel-body"><!-- panel-body begin -->
                <div class="table-responsive"><!-- table-responsive begin -->
                    <table class="table table-hover table-striped"><!-- table table-hover table-striped table-bordered begin -->
