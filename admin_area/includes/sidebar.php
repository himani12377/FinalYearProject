        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#terms"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-gavel"></i> Terms
                        <i class="fa fa-fw fa-caret-down"></i>
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#gallery"><!-- a href begin -->
                        
                        <i class="fa fa-fw fa-picture-o"></i> Gallery
                        <i class="fa fa-fw fa-caret-down"></i>
                        
                </a><!-- a href finish -->
                
                <ul id="gallery" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_gallery"> Add images </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_gallery"> View gallery </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
