...
if(isset($_POST['submit'])){
    ...
    $insert_product = "insert into products (cat_id,date,product_title,product_img,product_price,product_keywords,product_desc) values ('$cat',NOW(),'$product_title','$product_img','$product_price','$product_keywords','$product_desc')";
    
    $run_product = mysqli_query($con,$insert_product);
    
    if($run_product){
        
        echo "<script>alert('New product has been added sucessfully')</script>";
