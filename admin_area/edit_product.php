...
if(isset($_POST['update'])){
    ...
    $update_product = "update products set cat_id='$cat',date=NOW(),product_title='$product_title',product_img='$product_img',product_keywords='$product_keywords',product_desc='$product_desc',product_price='$product_price' where product_id='$p_id'";
