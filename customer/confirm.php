  ...
  <div id="top">
    ...
    <div class="container">
      ...
      <div class="col-md-6 offer">
        ...
        <a href="checkout.php"><?php items(); ?> Products in your cart | Total price: <?php total_price(); ?></a>
            ...
            <li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-content">
                                ...
                                <li><a href="Blue.html">BlueTech</a></li>
                            </ul>
                        </li>
                        <li>
            ...
            <div class="col-md-9">
                ...
                <div class="box">
                    ...
                    <?php
                        ...
                        $update_pending_order = "update customer_orders set order_status='$complete' where order_id='$update_id'";
